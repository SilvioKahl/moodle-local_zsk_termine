...
$string['zsk_termine:view'] = 'View upcoming events';
$string['zsk_termine:manage'] = 'Manage upcoming events and categories';
...
$string['privacy:metadata:license_server'] = 'Optional premium license verification sends only the license key and site URL to the configured license server. No user accounts, names or e-mail addresses are transmitted.';
$string['privacy:metadata:license_server:license_key'] = 'The optional premium license key.';
...
$string['license_heading'] = 'Optional premium features';
$string['license_heading_desc'] = 'This plugin is free to use. Core event management and display work without any purchase or license key. An optional premium key only unlocks additional Pro features (for example webhooks, iCal feed, reminders and statistics). Leave the key empty to stay on the free tier.';
$string['license_key'] = 'Optional premium license key';
$string['license_key_desc'] = 'Optional. Leave empty for free-tier use. A ZSK Termine premium key unlocks Pro features only. Health Dashboard keys (ZSK-HD-…) will not work here.';
