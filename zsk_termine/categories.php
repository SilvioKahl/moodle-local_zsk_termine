...
foreach (local_zsk_termine_get_categories() as $cat) {
    $table->data[] = [
        ...
        html_writer::link(
            ...
            get_string('delete'),
            ['class' => 'local-zsk-termine-confirm-delete']
        ),
    ];
}
echo html_writer::table($table);

$PAGE->requires->js_call_amd('local_zsk_termine/confirm_delete', 'init', [[
    'selector' => '.local-zsk-termine-confirm-delete',
    'title' => get_string('delete'),
    'message' => get_string('category_delete_confirm', 'local_zsk_termine'),
    'yeslabel' => get_string('delete'),
    'nolabel' => get_string('cancel'),
]]);
